...
def _get_prompt_input_key(inputs: Dict[str, Any], memory_variables: List[str]) -> str:
    ...
    # format the prompt.
    # "qualifier" is a special key that can be passed to qualify a AI prefix, e.g., AI is angry:
    # where " is angry" is the qualifier
    prompt_input_keys = list(set(inputs).difference(memory_variables + ["stop", "qualifier"]))
